...
<body>
<div class="text-left pl-5 ml-5 pt-5 px-5">

<a href="dasboard.php"><b>Dashboard</b></a>/<a  href="property.php"><b>Property</b></a>/<a class="text-secondary"><b>Add Property</b></a>
</div>
  <div class="pb-5 pt-5">
    <div class="row justify-content-center">
      <div class="col-lg-8">
        <div class="card px-3" style="border-radius: 10px;">
