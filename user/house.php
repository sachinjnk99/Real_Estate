  ...
  <div id="page-wrapper">
    <div class="full-row">
      <div class="container pt-5 mt-5 mb-4">
        <h4 class="d-block text-secondary position-relative  text-center px-3 mb-5 mt-3">House For Sale</h4>
        <div class="justify-content-center ">
          <div class="col-lg-12">
            <div class="row">
              <?php 
                    $query=mysqli_query($con,"SELECT property1.*, user.u_name, user.u_type, user.uimage FROM `property1`,`user` WHERE property1.uid = user.u_id && property_type='house for sale' && p_status = 'approved' ORDER BY pid DESC ");
