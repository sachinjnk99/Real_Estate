  ...
  <div id="page-wrapper">
      ...
      <div class="container">
        ...
        <div class="justify-content-center ">
          <div class="col-lg-12">
            <div class="row">
              <?php 
                    $query=mysqli_query($con,"SELECT property1.*, user.u_name, user.u_type, user.uimage FROM `property1`,`user` WHERE property1.uid = user.u_id && property_type='house for sale' && p_status = 'approved' ORDER BY u_id DESC LIMIT 6");
    ...
    <div id="page-wrapper">
      <div class="row">
        <div class="full-row">
          <div class="container">
            <h4 class=" text-secondary position-relative  text-left px-3 mb-5 mt-3">Land For Sale</h4>
            <div class="justify-content-center">
              <div class="col-lg-12">
                <div class="row">
                  <?php 
        ...
        <div id="page-wrapper">
          <div class="row">
            <div class="full-row">
              <div class="container">
                <h4 class=" text-secondary position-relative  text-left px-3 mb-5 mt-3">Property For Rent</h4>
                <div class="justify-content-center">
                  <div class="col-lg-12">
                    <div class="row">
                      <?php 
