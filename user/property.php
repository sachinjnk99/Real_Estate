                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="featured-thumb hover-zoomer mb-4">
                            <div class="overlay-black overflow-hidden position-relative img_style img"> <img src="property/prop/<?php echo $row['16'];?>" alt="pimage">
                                
                                <div class="sale bg-success text-white">For <?php echo $row['5'];?></div>
                                <div class="price text-danger text-capitalize"><b>Rs.<?php echo $row['12'];?> <span class="text-primary"><?php echo $row['11'];?> Sqft</span></b></div>
                                
                            </div>
                           
                            <div class="featured-thumb-data shadow-one size">
                                <div class="p-4">
